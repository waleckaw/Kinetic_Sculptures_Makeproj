...
void SystemClock_Config(void)
{
  ...
  */
  ...
  //one line added below, and LSE toggle added above
...
/**
  * @brief TIM3 Initialization Function for control law interrupt
  * @param None
  * @retval None
  */
void MX_TIM3_Init(void)
{
  ...
  //getpositions should be able to collect multiple samples between updates
  //making this value bigger on the sender weirdly seemed to make tracking worse
  ...
  HAL_TIM_Base_Init(&htim3); //Configure the timer
...
void MX_GPIO_Init(void)
{
  ...
  //ONLY LINE ADDED FROM ADDITIONAL PERIPHS CODE
...
//**************************** END EXTRA PERIPHS ADDED 3-8-20 **************************************
